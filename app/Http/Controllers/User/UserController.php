...
class UserController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('masyarakat')->attempt(['username' => $request->username, 'password' => $request->password])) {
            ...
            return redirect()->back()->with(['pesan' => 'Akun tidak terdaftar. Silahkan Registrasi.']);
        }
    }
    ...
    public function register(Request $request)
    {
        ...
        return redirect()->route('lapor.index')->with([
            'status' => 'success',
    ...
    public function laporan($siapa = '')
    {
        ...
        $pending = Pengaduan::where([['nik', Auth::guard('masyarakat')->user()->nik], ['status', 'pending']])->get()->count();
        ...
        $hitung = [$terverifikasi, $pending, $proses, $selesai];
