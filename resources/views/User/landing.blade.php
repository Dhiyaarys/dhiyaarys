...
@section('title', 'Warga Daigo! - Pengaduan Masyarakat')
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">Warga Daigo!</h4>
                </a>
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <select name="kategori_kejadian" class="custom-select" id="inputGroupSelect01" required>
                            ...
                            <option value="agama">Budaya</option>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Dhiyaarys • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
